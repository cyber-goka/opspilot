...
class HelpScreen(ModalScreen[None]):
    ...
    HELP_MARKDOWN = """\
### How do I quit OpsPilot?

Press `Ctrl+C` on your keyboard.
`q` also works if an input isn't currently focused.
If focus is on the prompt input box on the home screen, `esc` will close OpsPilot too.
...
* https://github.com/darrenburns/opspilot/blob/main/README.md
...
OpsPilot has very strong mouse support. Most things can be clicked.
...
"""
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="help-container") as vertical:
            vertical.border_title = "OpsPilot Help"
            with VerticalScroll():
