...
from opspilot.tui.config import LaunchConfig, OpsPilotChatModel
...
class UnknownModel(OpsPilotChatModel):
    pass
...
def get_model(
    ...
    """Given the id or name of a model as a string, return the OpsPilotChatModel.
